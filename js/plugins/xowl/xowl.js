...
(function($) {
  ...
  CKEDITOR.plugins.add('xowl', {
    ...
    init: function(editor) {
      ...
      if (xowlSettings.enabled === void 0 || xowlSettings.enabled !== 1) {
        return;
      }
      ...
      editor.addCommand('xowl_content_enhance_command', {
        exec: function() {
          ...
          $("<img/>").attr('src', "" + xowlSettings.basedir + "/js/plugins/xowl/icons/loader.gif").appendTo($loader);
          $.ajax({
            type: 'POST',
            dataType: "json",
        ...
        return $(editor.document.$).unbind('keyup').bind('keyup', function(evt) {
